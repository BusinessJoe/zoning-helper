...
import dxf.convert.parsedocx as parsedocx
from ..models import BylawSpecification, BylawException
...
class DocxBylawReader:
    ...
    def save_bylaws(self, bylaw_type):
        ...
        for bylaw in parse(self.html_text):
            ...
            if bylaw_type == 'spec':
                spec = BylawSpecification(**bylaw)
                spec.save()
            elif bylaw_type == 'exc':
                exc = BylawException(**bylaw)
                exc.save()
